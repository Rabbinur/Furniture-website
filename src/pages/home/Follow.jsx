...
const Follow = () => {
  return (
    <div className=" mt-[120px]">
      ...
      >
        <Container>
            <div className="grid md:grid-cols-2 grid-cols-1  place-content-between  gap-6">
                <div className="md:w-[400px] bg-white text-center py-10 rounded-md">
                ...
                <div className="md:w-[400px] bg-white text-center py-10 px-6 rounded-md">
